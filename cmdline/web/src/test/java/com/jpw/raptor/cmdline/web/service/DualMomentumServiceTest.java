...
public class DualMomentumServiceTest {
    ...
    public void test00() {
        ...
        File file        = new File(classLoader.getResource("dualmomentumfile.txt").getFile());

        DualMomentumService service = new DualMomentumService();
        List<DualMomentumModel> recs = service.getSymbolsFromFile(file.getAbsolutePath());

        assertEquals(3, recs.size());

        assertEquals("AAPL", recs.get(0).getSymbol());
        assertEquals("Apple Stock", recs.get(0).getName());

        assertEquals("IVV", recs.get(1).getSymbol());
        assertEquals("S&P 500", recs.get(1).getName());

        assertEquals("QQQ", recs.get(2).getSymbol());
        assertEquals("Nasdaq 100", recs.get(2).getName());
    ...
    public void test01() throws ParseException {
        ...
        DualMomentumService service = new DualMomentumService();
        DualMomentumModel   model   = new DualMomentumModel();
        service.computeAbsoluteReturn(model, list);

        // one Month
        assertEquals ( Double.parseDouble(df.format( ((258.05 - 270.4) / 270.4) * 100.0 )), model.getOneMonth(), 0.01 );

        // two Months
        assertEquals ( Double.parseDouble(df.format( ((258.05 - 283.29) / 283.29) * 100.0  )), model.getTwoMonths(), 0.01 );

        // three Months
        assertEquals ( Double.parseDouble(df.format( ((258.05 - 267.58) / 267.58) * 100.0  )), model.getThreeMonths(), 0.01 );

        // six Months
        assertEquals ( Double.parseDouble(df.format( ((258.05 - 249.44) / 249.44) * 100.0  )), model.getSixMonths(), 0.01 );

        // one year
        assertEquals ( Double.parseDouble(df.format( ((258.05 - 233.01) / 233.01) * 100.0  )), model.getOneYear(), 0.01 );
    }
    ...
    public void test02() throws ParseException {
        ...
        DecimalFormat       df      = new DecimalFormat("#.##");
        DualMomentumService service = new DualMomentumService();
        DualMomentumModel   e       = new DualMomentumModel();
        DualMomentumModel   r       = new DualMomentumModel();

        // reference
        r.setOneMonth(115.1);
        r.setTwoMonths(125.3);
        r.setThreeMonths(133.3);
        r.setSixMonths(-45.6);
        r.setOneYear(-101.2);

        // equity outperforms reference
        e.setOneMonth(119.7);
        e.setTwoMonths(130.1);
        e.setThreeMonths(144.4);
        e.setSixMonths(-40.3);
        e.setOneYear(-99.9);

        service.computeRelativeReturn(e, r);
        assertEquals ( Double.parseDouble(df.format( 119.7 - 115.1) ), e.getOneMonth(), 0.01 );
        assertEquals ( Double.parseDouble(df.format( 130.1 - 125.3) ), e.getTwoMonths(), 0.01 );
        assertEquals ( Double.parseDouble(df.format( 144.4 - 133.3) ), e.getThreeMonths(), 0.01 );
        assertEquals ( Double.parseDouble(df.format( -40.3 - -45.6) ), e.getSixMonths(), 0.01 );
        assertEquals ( Double.parseDouble(df.format( -99.9 - -101.2) ), e.getOneYear(), 0.01 );


        // equity underperforms reference
        e.setOneMonth(110.3);
        e.setTwoMonths(115.1);
        e.setThreeMonths(111.7);
        e.setSixMonths(-50.5);
        e.setOneYear(-117.7);

        service.computeRelativeReturn(e, r);
        assertEquals ( Double.parseDouble(df.format( 110.3 - 115.1) ), e.getOneMonth(), 0.01 );
        assertEquals ( Double.parseDouble(df.format( 115.1 - 125.3) ), e.getTwoMonths(), 0.01 );
        assertEquals ( Double.parseDouble(df.format( 111.7 - 133.3) ), e.getThreeMonths(), 0.01 );
        assertEquals ( Double.parseDouble(df.format( -50.5 - -45.6) ), e.getSixMonths(), 0.01 );
        assertEquals ( Double.parseDouble(df.format( -117.7 - -101.2) ), e.getOneYear(), 0.01 );
    ...
    public void createData() throws ParseException {
        ...
        list.add( new Quote("SPY",sdf.parse("20180322"),0.0,0.0,0.0, 263.67, 0) );	// 2
        ...
        list.add( new Quote("SPY",sdf.parse("20180316"),0.0,0.0,0.0, 274.2, 0) );	// 6
        ...
        list.add( new Quote("SPY",sdf.parse("20180309"),0.0,0.0,0.0, 278.87, 0) );	// 11
        ...
        list.add( new Quote("SPY",sdf.parse("20180302"),0.0,0.0,0.0, 269.08, 0) );	// 16
        ...
        list.add( new Quote("SPY",sdf.parse("20180222"),0.0,0.0,0.0, 270.4, 0) );	// 22
        ...
        list.add( new Quote("SPY",sdf.parse("20180123"),0.0,0.0,0.0, 283.29, 0) );	// 43
        ...
        list.add( new Quote("SPY",sdf.parse("20171221"),0.0,0.0,0.0, 267.58, 0) );    // 64
        ...
        list.add( new Quote("SPY",sdf.parse("20171121"),0.0,0.0,0.0, 259.99, 0) );    // 85
        ...
        list.add( new Quote("SPY",sdf.parse("20171023"),0.0,0.0,0.0, 256.11, 0) );    // 106
        ...
        list.add( new Quote("SPY",sdf.parse("20170922"),0.0,0.0,0.0, 249.44, 0) );    // 127
        ...
        list.add( new Quote("SPY",sdf.parse("20170326"),0.0,0.0,0.0, 233.01, 0) );    // 254
    }
