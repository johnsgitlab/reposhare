...
import com.jpw.raptor.jdbc.etf.EtfRowMapper;
 ...
 */
@Repository
public class EtfDAO implements EtfInterface {

    private static final Logger logger = LoggerFactory.getLogger(EtfDAO.class);
    ...
    public void addEmpty(String symbol) {
    	...
    	String sql = "INSERT INTO etf_tbl (symbol) values (?)";
        jdbcTemplate.update(sql, symbol);
    }

    @Override
    public int update(Etf v) {
        ...
        String      sql         = "UPDATE etf_tbl SET" +
                ...
                ", underlying_index='" + v.getUnderlyingIndex() + "'" +
                ", avg_daily_vol=" + df.format(v.getAvgDailyVol()) +
                ", inception='" + di + "'" +
    ...
    public int delete(String symbol) {
    	...
    	String sql = "DELETE FROM etf_tbl where symbol=?";
    ...
    public Etf get(String symbol) {
        ...
        try {
            String sql = "SELECT * FROM etf_tbl WHERE symbol=?";
            RowMapper<Etf> rowMapper = new EtfRowMapper();
            List<Etf> results = this.jdbcTemplate.query(sql, rowMapper, symbol);
            if ( results.size() > 0 )
    ...
    public List<Etf> getAll() {
    	String sql = "SELECT * FROM etf_tbl ORDER by symbol ASC";
    	RowMapper<Etf> rowMapper = new EtfRowMapper();
    ...
    public List<Etf> getOwned() {
        String sql = "SELECT * FROM etf_tbl WHERE tracks='own' ORDER BY symbol ASC";
        RowMapper<Etf> rowMapper = new EtfRowMapper();
        return this.jdbcTemplate.query(sql, rowMapper);
    }
    ...
    public List<Etf> getTracked() {
        String sql = "SELECT * FROM etf_tbl WHERE tracks='tracked' or tracks='own' ORDER BY symbol ASC ";
        RowMapper<Etf> rowMapper = new EtfRowMapper();
        return this.jdbcTemplate.query(sql, rowMapper);
    }
    ...
    public List<Etf> getRelevant() {
        String sql = "SELECT * FROM etf_tbl WHERE tracks='relevant' or tracks='tracked' or tracks='own' ORDER BY symbol ASC ";
        RowMapper<Etf> rowMapper = new EtfRowMapper();
        return this.jdbcTemplate.query(sql, rowMapper);
    }
    ...
    public List<Etf> getByAssetClass(String assetClass) {
        ...
        String sql = "SELECT * FROM etf_tbl WHERE asset_class=?  ORDER by symbol ASC";
        RowMapper<Etf> rowMapper = new EtfRowMapper();
    ...
    public List<Etf> getByAssetClassFundType(String assetClass, String fundType) {
        ...
        String sql = "SELECT * FROM etf_tbl WHERE asset_class=? and fund_type=? ORDER BY symbol ASC ";
        RowMapper<Etf> rowMapper = new EtfRowMapper();
    ...
    public List<Etf> getByAssetClassFundTypeSubType(String assetClass, String fundType, String subType) {
        ...
        String sql = "SELECT * FROM etf_tbl WHERE asset_class=? and fund_type=? and fund_sub_type=? ORDER BY symbol ASC ";
        RowMapper<Etf> rowMapper = new EtfRowMapper();
    ...
    public List<Etf> getByAssetClassFundTypeSubTypeFactor(String assetClass, String fundType, String subType, String factor)  {
        ...
        String sql = "SELECT * FROM etf_tbl WHERE asset_class=? and fund_type=? and fund_sub_type=? and factor=? ORDER BY symbol ASC ";
        RowMapper<Etf> rowMapper = new EtfRowMapper();
    ...
    public List<Etf> getFactors() {
        String sql = "SELECT * FROM etf_tbl WHERE factor!='' ORDER BY symbol ASC ";
        RowMapper<Etf> rowMapper = new EtfRowMapper();
        return this.jdbcTemplate.query(sql, rowMapper);
    }
    ...
    public List<Etf> getFactorsAll() {
        String sql = "SELECT * FROM etf_tbl WHERE factor!='' or fund_sub_type='growth' or fund_sub_type='value' ORDER BY symbol ASC ";
        RowMapper<Etf> rowMapper = new EtfRowMapper();
        return this.jdbcTemplate.query(sql, rowMapper);
    }
    ...
    public List<Etf> getFactorsByAssetClass(String assetClass) {
        ...
        String sql = "SELECT * FROM etf_tbl WHERE asset_class=? and factor!='' ORDER BY symbol ASC ";
        RowMapper<Etf> rowMapper = new EtfRowMapper();
        return this.jdbcTemplate.query(sql, rowMapper, assetClass);
    }
    ...
    public List<Etf> getFactorAndAssetClass(String assetClass, String assetFactor) {
        ...
        String sql = "SELECT * FROM etf_tbl WHERE asset_class=? and factor=? ORDER BY symbol ASC ";
        RowMapper<Etf> rowMapper = new EtfRowMapper();
        return this.jdbcTemplate.query(sql, rowMapper, assetClass, assetFactor);
    }
}
