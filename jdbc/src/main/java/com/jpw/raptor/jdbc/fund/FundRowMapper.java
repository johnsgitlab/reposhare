...
public class FundRowMapper implements RowMapper<Fund>  {
    ...
    private static final Logger logger = LoggerFactory.getLogger(FundRowMapper.class);
    ...
    public Fund mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        rec.setMinimum(rs.getDouble("minimum"));
        rec.setFrontLoad(rs.getDouble("front_load") );
        rec.setBackLoad(rs.getDouble("back_load"));
